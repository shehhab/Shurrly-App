...
class HideSessionHistoryController extends Controller
{
    public function __invoke(AcceptRequest $request){
        try {
            ...
            // Check if the session has already been approved by the seeker
            if ($session->seeker_history === 0) {
